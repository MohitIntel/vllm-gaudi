...
from vllm_gaudi.utils import (hpu_backend_string, hpu_device_string,
                              is_fake_hpu)
from vllm.worker.cache_engine import CacheEngine
from vllm_gaudi.worker.hpu_enc_dec_model_runner import HPUEncoderDecoderModelRunner
from vllm_gaudi.worker.hpu_model_runner import HPUModelRunner, HPUModelRunnerBase
from vllm_gaudi.worker.hpu_pooling_model_runner import HPUPoolingModelRunner
...
class HPUWorker(LocalOrDistributedWorkerBase):
    ...
    def add_prompt_adapter(
            self, prompt_adapter_request) -> bool: ##: PromptAdapterRequest) -> bool:
